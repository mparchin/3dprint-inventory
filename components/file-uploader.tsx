...
export default function FileUploader({
    ...
    useEffect(() => {
        for (let i = 0; i < tempFiles.length; i++) {
            ...
            formData.append(`file-${i}`, ref.current.files![i]);
        ...
        <div className="border rounded-2xl p-2">
            <div className="mb-4 sm:grid grid-cols-2">
                <div className="sm:w-48 w-72 aspect-square grid grid-cols-12 grid-rows-12 bg-sidebar rounded-2xl ml-auto mr-auto mb-2">
                    <RemoveButton />
                    <div className="w-full bg-purple-500 col-span-12 row-span-12 row-start-1 col-start-1 z-0 flex flex-col gap-2 p-3"></div>
                </div>
                <div className="sm:w-48 w-72 row-span-2 grid grid-cols-12 grid-rows-12 bg-sidebar rounded-2xl ml-auto mr-auto mb-2">
                    ...
                    <div className="w-full col-span-12 row-span-12 row-start-1 col-start-1 z-0 flex flex-col gap-2 p-4">
                        <p className="grow">Red Rising (The Red Rising Trilogy, Book 1) ... .torrent</p>
                        <Field orientation={"horizontal"}>
                            <FieldLabel htmlFor="grams">Weight:</FieldLabel>
                            <InputGroup>
                                <InputGroupInput id="grams" type="number" placeholder="32" />
                        ...
                        <Field orientation={"horizontal"}>
                            ...
                            <InputGroup>
                                <InputGroupInput id="repeats" type="number" placeholder="1" defaultValue={"1"} />
                                <InputGroupAddon align={"inline-end"}>
                                    <Tooltip>
                                        <TooltipTrigger type="button">
                                            #
                        ...
                        <Field orientation={"horizontal"}>
                            ...
                            <InputGroup>
                                <InputGroupInput id="elec" type="number" placeholder="12" />
                                <InputGroupAddon align={"inline-end"}>
                                    <Tooltip>
                                        <TooltipTrigger type="button">
                                            g
